...
public class Strand implements Serializable{
    ...
    //Rotation/translation information for use during minimization
    //referred to by ContSCObjFunction
    boolean rotTrans = false;//Can the strand translate and rotate?
    double strStartCOM[] = null;
	// the position of the strand's COM at the beginning of minimization
    double curTrans[];
    double curRotMatrix[][];//The current rigid-body position of the strand
    //was generated by a translation of curTrans, followed by a rotation using curRotMatrix
    //around the point strStartCOM + curTrans
    double curRotAngles[];//Angles used to generate curRotMatrix:
    //curRotMatrix = (rot. by curRotAngles[2] about z-axis)X(rot. by curRotAngles[1] about y-axis)X(rot. by curRotAngles[0] about x-axis)
	...
	Strand(){
		...
		rcl = new ResidueConformationLibrary();
	}
	...
	public void rotateStrand(double dx, double dy, double dz,
		double thetaDeg, Molecule m, double cx, double cy, double cz) {
