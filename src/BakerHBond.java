...
public class BakerHBond {
	...
	//KER: HBond Poly1D Functions
	Poly1D delta_bb_helix;
	Poly1D delta_bb_sheet;
	Poly1D delta_bb_other;
	Poly1D delta_sc_sp2;
	Poly1D delta_sc_sp3;
	...
	Poly1D phi_bb_sheet;
	Poly1D phi_bb_other;
	Poly1D theta_bb_helix;
	Poly1D theta_bb_sheet;
	Poly1D theta_bb_other;

	Poly1D chi_sc_sp2_short;
	Poly1D chi_sc_sp2_long;
	Poly1D phi_sc_sp2_short;
	Poly1D phi_sc_sp2_long;
	Poly1D theta_sc_sp2_short;
	Poly1D theta_sc_sp2_long;

	Poly1D phi_sc_sp3_short;
	Poly1D theta_sc_sp3_short;
	Poly1D phi_sc_sp3_long;
	Poly1D theta_sc_sp3_long;
	...
	private void readPoly1D(){

		delta_bb_helix = new Poly1D("1.70 2.60 7 76.92576075872044327753 -920.31423728022900832002 4582.98159388960266369395 -12230.47471070210121979471 18585.45580048343617818318 -15372.59121156383480411023 5445.07452913820725370897 ");
		delta_bb_sheet = new Poly1D("1.70 2.60 7 144.34922152025424679778 -1884.15932310602352117712 10261.76991717469900322612 -29877.53999254936570650898 49086.73306215617776615545 -43168.39618908205738989636 15875.40397483624838059768 ");
		delta_bb_other = new Poly1D("1.70 2.60 7 196.42741354417250931874 -2484.78990744927750711213 13070.16612191789863572922 -36624.76264512752823065966 57723.94278221482090884820 -48573.53827961719071026891 17067.48005813081908854656 ");
		delta_sc_sp2 = new Poly1D("1.45 3.00 7 -15.65765464358041292314 215.33240577975831797630 -1213.59836768308628052182 3577.06985723827438050648 -5794.21906707604011899093 4869.95323566881415899843 -1651.50066037367196258856 ");
		delta_sc_sp3 = new Poly1D("1.60 3.00 7 -42.31970036824986181045 590.48118211852386139071 -3392.85116566297801909968 10263.53084035706160648260 -17216.76429296930655254982 15164.63863552352813712787 -5472.86050937056279508397 ");
		chi_bb_helix = new Poly1D("-180.00 180.00 5 0.00000000961038168880 -0.00000113871638696979 -0.00037868589809405862 0.03800930299233887255 4.66385932829456351101 ");
		phi_bb_helix = new Poly1D("0.26 -1.00 7 33.21247794981988477048 -37.68933459537822727725 -62.63560337026657975912 60.45920219352220925657 62.92834384918143086907 8.74080551597517541040 -0.28531776573979594769 ");
		theta_bb_helix = new Poly1D("0.09 -1.00 7 342.42851535798280337985 560.09726474317949396209 -5.92491183262715370716 -385.60022370399616420400 -169.36291868437217544852 1.55364191702288212404 7.51796669968754560642 ");
		chi_bb_sheet = new Poly1D("-180.00 180.00 9 -0.00000000000000002410 -0.00000000000000094448 0.00000000000169221646 0.00000000003755034428 -0.00000003943090905246 -0.00000029074458397694 0.00035081894740413851 0.00026085932547542504 -0.69743806191339363654 ");
		phi_bb_sheet = new Poly1D("0.26 -1.00 7 -30.60491834465477012373 -131.40114346116789079133 -147.82544216565378292216 -38.11140874654714849612 12.78070615011911570491 8.48280508773128438804 2.77747808337573687254 ");
		theta_bb_sheet = new Poly1D("0.09 -1.00 4 1.57503870188756001092 -1.06484333943499343000 7.16935628756164167186 6.74927432214103362185 ");
		chi_bb_other = new Poly1D("-180.00 180.00 8 0.00000000000000187922 -0.00000000000012371591 -0.00000000012264568621 0.00000000996420554609 0.00000210756502485180 -0.00020282841545786161 -0.00215309358577880439 1.11783093883408080060 ");
		//chi_bb_other.printFunction();
		phi_bb_other = new Poly1D("0.26 -1.00 7 -7.74234267695908595641 -87.14824460418199691958 -135.42189508877558523636 -50.14595702491587303484 16.12583756394147371793 11.80465464213827608830 0.51275398347199618865 ");
		theta_bb_other = new Poly1D("0.09 -1.00 5 -14.83314401229022116979 -24.89844884059162666290 -8.43802158761153009436 8.76727282946360553240 4.47130231637154551549 ");
		chi_sc_sp2_short = new Poly1D("0.00 180.00 6 0.00000000004304423759 0.00000001119712218952 -0.00000708716113943940 0.00068371691994235397 -0.00647416044380971518 -0.05735940642119304045 ");
		//chi_sc_sp2_short.printFunction();
		phi_sc_sp2_short = new Poly1D("0.34 -1.00 5 -7.87625495668602582100 -12.25817564525566183420 4.11346097819066613965 8.62576263592866787633 0.06509380929670126326 ");
		theta_sc_sp2_short = new Poly1D("-0.17 -1.00 5 -11.77820902027137428547 -36.43126824079791248323 -39.53971358030011629126 -8.54491815494485962290 3.45575596246188432303 ");
		chi_sc_sp2_long = new Poly1D("0.00 180.00 8 0.00000000000005893090 -0.00000000003909603506 0.00000001017599946156 -0.00000130600611716664 0.00008493675404931176 -0.00253493923961143871 0.01723449624692728610 0.60254004576696240658 ");
		phi_sc_sp2_long = new Poly1D("0.50 -1.00 4 0.85822499622818793075 3.02208096366379708186 1.85514165923868112884 -1.20125735479177331300 ");
		theta_sc_sp2_long = new Poly1D("0.17 -0.98 4 -1.77513856757575716472 -1.34801805450061595870 2.56092069703684765969 0.27895441899056011570 ");
		phi_sc_sp3_short = new Poly1D("0.17 -1.00 4 -0.92188267159473979984 9.47562101080037422207 9.03284152160650499752 -0.24658458159896870510 ");
		theta_sc_sp3_short = new Poly1D("-0.17 -1.00 5 6.30244240590163684601 11.10939560974528106385 5.97747799525861189807 8.43782213557545901494 4.59307407681592039239 ");
		phi_sc_sp3_long = new Poly1D("0.50 -1.00 4 -0.02329171617200254119 3.52753356229713066483 3.40660535785749329918 -0.88323596956894478982 ");
		theta_sc_sp3_long = new Poly1D("0.17 -1.00 3 1.79892178902436628007 3.18903183717485250170 -0.21928164239458927676 ");



		/*delta_bb_helix = new Poly1D("1.70 2.60 7 76.92576076 -920.31423728 4582.98159389 -12230.47471070 18585.45580048 -15372.59121156 5445.07452914 ");
			delta_bb_sheet = new Poly1D("1.70 2.60 7 144.34922152 -1884.15932311 10261.76991717 -29877.53999255 49086.73306216 -43168.39618908 15875.40397484 ");
			delta_bb_other = new Poly1D("1.70 2.60 7 196.42741354 -2484.78990745 13070.16612192 -36624.76264513 57723.94278221 -48573.53827962 17067.48005813 ");
			delta_sc_sp2 = new Poly1D("1.45 3.00 7 -15.65765464 215.33240578 -1213.59836768 3577.06985724 -5794.21906708 4869.95323567 -1651.50066037 ");
			delta_sc_sp3 = new Poly1D("1.60 3.00 7 -42.31970037 590.48118212 -3392.85116566 10263.53084036 -17216.76429297 15164.63863552 -5472.86050937 ");
			chi_bb_helix = new Poly1D("-180.00 180.00 5 0.00000001 -0.00000114 -0.00037869 0.03800930 4.66385933 ");
			phi_bb_helix = new Poly1D("0.26 -1.00 7 33.21247795 -37.68933460 -62.63560337 60.45920219 62.92834385 8.74080552 -0.28531777 ");
			theta_bb_helix = new Poly1D("0.09 -1.00 7 342.42851536 560.09726474 -5.92491183 -385.60022370 -169.36291868 1.55364192 7.51796670 ");
			chi_bb_sheet = new Poly1D("-180.00 180.00 9 -0.00000000 -0.00000000 0.00000000 0.00000000 -0.00000004 -0.00000029 0.00035082 0.00026086 -0.69743806 ");
			phi_bb_sheet = new Poly1D("0.26 -1.00 7 -30.60491834 -131.40114346 -147.82544217 -38.11140875 12.78070615 8.48280509 2.77747808 ");
			theta_bb_sheet = new Poly1D("0.09 -1.00 4 1.57503870 -1.06484334 7.16935629 6.74927432 ");
			chi_bb_other = new Poly1D("-180.00 180.00 13 0.00000000 -0.00000000 -0.00000000 0.00000000 -0.00000000 -0.00000000 0.00000000 0.00000000 -0.00000008 0.00000108 0.00023680 -0.00043897 0.78625239 ");
			phi_bb_other = new Poly1D("0.26 -1.00 7 -7.74234268 -87.14824460 -135.42189509 -50.14595702 16.12583756 11.80465464 0.51275398 ");
			theta_bb_other = new Poly1D("0.09 -1.00 5 -14.83314401 -24.89844884 -8.43802159 8.76727283 4.47130232 ");
			chi_sc_sp2_short = new Poly1D("0.00 180.00 6 0.00000000 0.00000001 -0.00000709 0.00068372 -0.00647416 -0.05735941 ");
			phi_sc_sp2_short = new Poly1D("0.34 -1.00 5 -7.87625496 -12.25817565 4.11346098 8.62576264 0.06509381 ");
			theta_sc_sp2_short = new Poly1D("-0.17 -1.00 5 -11.77820902 -36.43126824 -39.53971358 -8.54491815 3.45575596 ");
			chi_sc_sp2_long = new Poly1D("0.00 180.00 8 0.00000000 -0.00000000 0.00000001 -0.00000131 0.00008494 -0.00253494 0.01723450 0.60254005 ");
			phi_sc_sp2_long = new Poly1D("0.50 -1.00 4 0.85822500 3.02208096 1.85514166 -1.20125735 ");
			theta_sc_sp2_long = new Poly1D("0.17 -0.98 4 -1.77513857 -1.34801805 2.56092070 0.27895442 ");
			phi_sc_sp3_short = new Poly1D("0.17 -1.00 4 -0.92188267 9.47562101 9.03284152 -0.24658458 ");
			theta_sc_sp3_short = new Poly1D("-0.17 -1.00 5 6.30244241 11.10939561 5.97747800 8.43782214 4.59307408 ");
			phi_sc_sp3_long = new Poly1D("0.50 -1.00 4 -0.02329172 3.52753356 3.40660536 -0.88323597 ");
			theta_sc_sp3_long = new Poly1D("0.17 -1.00 3 1.79892179 3.18903184 -0.21928164 ");*/
	...
	public void calculateBakerHBondEnergy(double[] coordinates, int curIndex,
	...
	public void calculateBakerHBondGradient(int curIndex, Molecule m) {
		...
		while(iter.hasNext()){
			...
			if(cosThetaValDeriv[Poly1D.DERIV] == 0.0)
				continue;
			...
			if(cosPhiValDeriv[Poly1D.DERIV] == 0.0)
				continue;	
			...
			if(acceptType == SP2 ){
				...
				if(chiValDeriv[Poly1D.DERIV] == 0.0)
					continue;
				...
				//Add chi gradient
				m.gradient[atomCx3] += dChiDR[0]*chiValDeriv[Poly1D.DERIV]*newMult;
				m.gradient[atomCx3+1] += dChiDR[1]*chiValDeriv[Poly1D.DERIV]*newMult;
				m.gradient[atomCx3+2] += dChiDR[2]*chiValDeriv[Poly1D.DERIV]*newMult;
				m.gradient[atomBx3] += dChiDR[3]*chiValDeriv[Poly1D.DERIV]*newMult;
				m.gradient[atomBx3+1] += dChiDR[4]*chiValDeriv[Poly1D.DERIV]*newMult;
				m.gradient[atomBx3+2] += dChiDR[5]*chiValDeriv[Poly1D.DERIV]*newMult;
				m.gradient[atomAx3] += dChiDR[6]*chiValDeriv[Poly1D.DERIV]*newMult;
				m.gradient[atomAx3+1] += dChiDR[7]*chiValDeriv[Poly1D.DERIV]*newMult;
				m.gradient[atomAx3+2] += dChiDR[8]*chiValDeriv[Poly1D.DERIV]*newMult;
				m.gradient[atomHx3] += dChiDR[9]*chiValDeriv[Poly1D.DERIV]*newMult;
				m.gradient[atomHx3+1] += dChiDR[10]*chiValDeriv[Poly1D.DERIV]*newMult;
				m.gradient[atomHx3+2] += dChiDR[1]*chiValDeriv[Poly1D.DERIV]*newMult;
			...
			//Add AHdist gradient
			m.gradient[atomHx3] += HAx*HAvalDeriv[Poly1D.DERIV]*newMult;
			m.gradient[atomHx3+1] += HAy*HAvalDeriv[Poly1D.DERIV]*newMult;
			m.gradient[atomHx3+2] += HAz*HAvalDeriv[Poly1D.DERIV]*newMult;
			m.gradient[atomAx3] += -HAx*HAvalDeriv[Poly1D.DERIV]*newMult;
			m.gradient[atomAx3+1] += -HAy*HAvalDeriv[Poly1D.DERIV]*newMult;
			m.gradient[atomAx3+2] += -HAz*HAvalDeriv[Poly1D.DERIV]*newMult;

			//Add cosTheta gradient
			m.gradient[atomDx3] += dCosThetaDR[0]*cosThetaValDeriv[Poly1D.DERIV]*newMult;
			m.gradient[atomDx3+1] += dCosThetaDR[1]*cosThetaValDeriv[Poly1D.DERIV]*newMult;
			m.gradient[atomDx3+2] += dCosThetaDR[2]*cosThetaValDeriv[Poly1D.DERIV]*newMult;
			m.gradient[atomAx3] += dCosThetaDR[3]*cosThetaValDeriv[Poly1D.DERIV]*newMult;
			m.gradient[atomAx3+1] += dCosThetaDR[4]*cosThetaValDeriv[Poly1D.DERIV]*newMult;
			m.gradient[atomAx3+2] += dCosThetaDR[5]*cosThetaValDeriv[Poly1D.DERIV]*newMult;


			//Add cosPhi gradient
			m.gradient[atomHx3] += dCosPhiDR[0]*cosPhiValDeriv[Poly1D.DERIV]*newMult;
			m.gradient[atomHx3+1] += dCosPhiDR[1]*cosPhiValDeriv[Poly1D.DERIV]*newMult;
			m.gradient[atomHx3+2] += dCosPhiDR[2]*cosPhiValDeriv[Poly1D.DERIV]*newMult;
			m.gradient[atomBx3] += dCosPhiDR[3]*cosPhiValDeriv[Poly1D.DERIV]*newMult;
			m.gradient[atomBx3+1] += dCosPhiDR[4]*cosPhiValDeriv[Poly1D.DERIV]*newMult;
			m.gradient[atomBx3+2] += dCosPhiDR[5]*cosPhiValDeriv[Poly1D.DERIV]*newMult;
	...
	public void addIfValid(int atom1, int atom2,Molecule m) {
		boolean badPair = false;
		Atom hydro;
		Atom accept;
		Atom donor;
